...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_voyager(
    KC_NO,  UNDO_X,   CUT_X,   SEL_ALL,  TD(TD_COPY_PASTE),       KC_GRV,                   LGUI(LSFT(KC_4)), CW_TOGG, KC_NO, KC_NO, KC_NO, KC_NO,
    ...
    KC_NO,  KC_QUOTE, KC_MINS, KC_COMM,  KC_DOT,                  KC_SLASH,                 KC_J,             KC_M,    KC_G,  KC_B,  KC_V,  KC_ENT,
                                         LT(MEDIA_NAV, KC_SPACE), OSM(MOD_LSFT),            MEH_T(KC_TAB),    LT(NUM, KC_R)
  ),
  [SYMBOLS] = LAYOUT_voyager(
    ...
    KC_NO,   KC_TILD, KC_PLUS, KC_COMM,  KC_DOT,  KC_PERC,           KC_AT,   KC_LBRC, KC_RBRC, KC_COLN, KC_QUOTE, KC_TRNS,
                                         KC_TRNS,  KC_TRNS,          KC_TRNS, KC_TRNS
  ),
  [MEDIA_NAV] = LAYOUT_voyager(
    KC_NO,   KC_BRID,       KC_BRIU,       KC_VOLD,       KC_VOLU,        KC_MUTE,          KC_NO,              KC_NO,              KC_NO,   KC_NO,         KC_NO,       KC_NO,
    KC_TRNS, KC_MSTP,       KC_MPRV,       KC_MNXT,       KC_MPLY,        KC_NO,            KC_PAGE_UP,         LCTL(LSFT(KC_TAB)), KC_UP,   LCTL(KC_TAB),  KC_HOME,     KC_NO,
    KC_NO,   OSM(MOD_LCTL), OSM(MOD_LSFT), OSM(MOD_LALT), OSM(MOD_LGUI),  MS_BTN1,          KC_PGDN,            KC_LEFT,            KC_DOWN, KC_RIGHT,      KC_END,      KC_NO,
    KC_NO,   KC_NO,         KC_NO,         KC_NO,         KC_NO,          KC_NO,            KC_MISSION_CONTROL, LGUI(KC_LBRC),      KC_APP,  LGUI(KC_RBRC), DUAL_FUNC_0, KC_NO,
                                                          KC_TRNS,        KC_TRNS,          KC_TRNS,            KC_TRNS
  ),
  [NUM] = LAYOUT_voyager(
